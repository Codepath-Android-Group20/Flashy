...
class OtherUsersFlashcardAdapter (private val context: Context,
                                  private val flashcards: ArrayList<Flashcard>)
                        : RecyclerView.Adapter<OtherUsersFlashcardAdapter.ViewHolder>()  {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): OtherUsersFlashcardAdapter.ViewHolder {
        val view= LayoutInflater.from(context).inflate(R.layout.flash_card, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: OtherUsersFlashcardAdapter.ViewHolder, position: Int) {
